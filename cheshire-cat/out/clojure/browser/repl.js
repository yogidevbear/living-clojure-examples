...
var seq__10677_10681 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__10678_10682 = null;
var count__10679_10683 = (0);
var i__10680_10684 = (0);
while(true){
if((i__10680_10684 < count__10679_10683)){
var str_10685 = cljs.core._nth.call(null,chunk__10678_10682,i__10680_10684);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_10685);

var G__10686 = seq__10677_10681;
var G__10687 = chunk__10678_10682;
var G__10688 = count__10679_10683;
var G__10689 = (i__10680_10684 + (1));
seq__10677_10681 = G__10686;
chunk__10678_10682 = G__10687;
count__10679_10683 = G__10688;
i__10680_10684 = G__10689;
continue;
} else {
var temp__4657__auto___10690 = cljs.core.seq.call(null,seq__10677_10681);
if(temp__4657__auto___10690){
var seq__10677_10691__$1 = temp__4657__auto___10690;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__10677_10691__$1)){
var c__7996__auto___10692 = cljs.core.chunk_first.call(null,seq__10677_10691__$1);
var G__10693 = cljs.core.chunk_rest.call(null,seq__10677_10691__$1);
var G__10694 = c__7996__auto___10692;
var G__10695 = cljs.core.count.call(null,c__7996__auto___10692);
var G__10696 = (0);
seq__10677_10681 = G__10693;
chunk__10678_10682 = G__10694;
count__10679_10683 = G__10695;
i__10680_10684 = G__10696;
continue;
} else {
var str_10697 = cljs.core.first.call(null,seq__10677_10691__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),str_10697);

var G__10698 = cljs.core.next.call(null,seq__10677_10691__$1);
var G__10699 = null;
var G__10700 = (0);
var G__10701 = (0);
seq__10677_10681 = G__10698;
chunk__10678_10682 = G__10699;
count__10679_10683 = G__10700;
i__10680_10684 = G__10701;
continue;
}
} else {
}
...
var args10704 = [];
var len__8290__auto___10707 = arguments.length;
var i__8291__auto___10708 = (0);
while(true){
if((i__8291__auto___10708 < len__8290__auto___10707)){
args10704.push((arguments[i__8291__auto___10708]));

var G__10709 = (i__8291__auto___10708 + (1));
i__8291__auto___10708 = G__10709;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str("Invalid arity: "),cljs.core.str(args10704.length)].join('')));
...
var script__$1 = (function (){var G__10714 = script;
goog.object.set(G__10714,"type","text/javascript");

goog.object.set(G__10714,"onload",onload);

goog.object.set(G__10714,"onreadystatechange",onload);

return G__10714;
})();
if((opt_sourceText == null)){
var G__10715 = script__$1;
goog.object.set(G__10715,"src",src);

return G__10715;
} else {
var G__10716 = script__$1;
goog.dom.setTextContext(G__10716,opt_sourceText);
...
var path_10717 = (goog.dependencies_.nameToPath[src]);
goog.object.remove(goog.dependencies_.visited,path_10717);

goog.object.remove(goog.dependencies_.written,path_10717);

goog.object.remove(goog.dependencies_.written,[cljs.core.str(goog.basePath),cljs.core.str(path_10717)].join(''));
} else {
}
